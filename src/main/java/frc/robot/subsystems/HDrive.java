...
public class HDrive extends SubsystemBase {
  ...
  public HDrive() {
    ...
    leftLeader.configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true,Constants.kDriveCurrentLimitContinuous,Constants.kDriveCurrentLimitPeak,Constants.kDriveCurrentLimitTime));
    // Init Right Leader
    rightLeader  = new WPI_TalonFX(Constants.kRightLeader);
    rightLeader.setInverted(Constants.invertDrivetrainMotors);
    rightLeader.configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true,Constants.kDriveCurrentLimitContinuous,Constants.kDriveCurrentLimitPeak,Constants.kDriveCurrentLimitTime));

    hLeader = new WPI_TalonFX(Constants.kHLeader);
    hLeader.configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true,Constants.kHDriveCurrentLimit,Constants.kHDriveCurrentLimit,Constants.kHDriveCurrentLimitTime));
    ...
    for(int i = 0; i < leftFollowers.length; ++i) {
        ...
        leftFollowers[i].configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true,Constants.kDriveCurrentLimitContinuous,Constants.kDriveCurrentLimitPeak,Constants.kDriveCurrentLimitTime));
    }
    ...
    for(int i = 0; i < rightFollowers.length; ++i) {
        ...
        rightFollowers[i].configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true,Constants.kDriveCurrentLimitContinuous,Constants.kDriveCurrentLimitPeak,Constants.kDriveCurrentLimitTime));
    }
    ...
    for(int i = 0; i < hFollowers.length; ++i) {
        ...
        hFollowers[i].configStatorCurrentLimit(new StatorCurrentLimitConfiguration(true,Constants.kHDriveCurrentLimit,Constants.kHDriveCurrentLimit,Constants.kHDriveCurrentLimitTime));
